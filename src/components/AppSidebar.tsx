...
export function AppSidebar() {
  ...
  const adminMenu: MenuItem[] = [
    ...
    { label: 'Pinjam (Guru)',  icon: BookMarked,      path: '/borrow-request',  roles: ['siswa', 'guru'] },
  ...
  return (
    <aside className="hidden md:flex w-64 bg-white border-r border-gray-100 flex-col h-screen sticky top-0 z-40 shadow-sm">
      {/* Brand Header */}
...
export function MobileSidebarTrigger() {
  return null; // Deprecated, use MobileSidebar directly
}
