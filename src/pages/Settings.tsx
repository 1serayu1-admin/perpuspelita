...
import { Settings, Upload, ImageIcon, Save, Plus, Trash2, Globe, ShieldCheck, Wifi, Users, UserPlus, KeyRound } from 'lucide-react';
      ...
      {activeTab === 'users' && user?.role === 'global_super_admin' && (
        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground mt-2">Gunakan halaman Admin Management untuk sementara</p>
          </div>
        </div>
      )}
    </AppLayout>
