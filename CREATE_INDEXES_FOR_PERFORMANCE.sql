-- =============================================
-- CREATE INDEXES TO FIX TIMEOUT ISSUES
-- Run this in Supabase SQL Editor
-- =============================================

-- Index untuk mempercepat getUserRole (query paling sering timeout)
...
-- Index untuk borrowings (transaksi peminjaman)
CREATE INDEX IF NOT EXISTS idx_borrowings_student_id 
ON public.borrowings(student_id);
...
WHERE schemaname = 'public' 
  AND tablename IN ('user_roles', 'profiles', 'books', 'categories', 'students', 'teachers', 'borrowings')
